...
r12 = Restaurant.create(:name => "Ryo's Noodles Crows Nest", :address => '125 Falcon St, Crows Nest NSW 2065', :description => 'Cosy restaurant doling out classic Japanese food like ramen, chicken soup and rice dishes.', :website => 'https://ryosramen.com.au/', :logo => 'https://www.ryosnoodles.com.au/wp-content/uploads/2017/06/logo-white.png', :image => 'https://lh3.googleusercontent.com/p/AF1QipOT_p6xHKskngkCvDS0kaSBbABdQlRlim2RKOlD=s1360-w1360-h1020')
